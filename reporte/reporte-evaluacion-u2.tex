...
Tareas de Aprendizaje (SA, NS, DE) y Herramienta Alternativa (AU)}}
\author{}
\date{}
...
\subsection{DE 1 — Clasificación con Random Forest sobre breast-cancer.csv}
...
\subsection{DE 2 — Regresión con Random Forest sobre beisbol.csv}
...
\subsubsection{Diseño, evaluación y optimización}
\textbf{Hiperparámetros óptimos (GridSearchCV, RMSE):} $n\_estimators=50$,
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth]{img/repo_github.png}
